## Additional Syntax for YAML Configuration Files

All YAML 1.2.2 constructs are supported. The structures below are the specific conventions used in configuration files for defining operation constraints, profiles, and approximation parameters.
...
Lists are given as standard YAML sequences: `[ <item1>, <item2>, ... ]`.
...
- and `<value>` is a numeric or a symbolic value.
  - Symbolic values are given as shown in the examples.
    - Recognized symbols include `π`, `e`, and `φ`.
